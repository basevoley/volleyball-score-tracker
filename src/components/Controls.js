...
const ControlSection = ({ title, disabled = false, checked, checkedLabel = 'Mostrar', unCheckedLabel = 'Ocultar', onToggle, children }) => (
    <Box sx={{ paddingY: 1 }}>
...
const SequenceRow = ({ seq, isRunning, activeSequenceId, currentStepIndex, activeSteps, automationsEnabled, toggleAutomation, runSequence, stop, socket }) => {
