...
import UniformIcon from '../../shared/components/UniformIcon';
...
export function TeamColorSelector({ color, onColorChange, iconSize = 50 }: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        <UniformIcon shirtColor={tempColor} shirtNumber="" size={iconSize}/>
      </div>
