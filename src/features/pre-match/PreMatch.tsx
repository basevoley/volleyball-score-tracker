...
function PreMatch({ setMatchDetails, matchDetails }: Props) {
  ...
  const handleStatChange = (team: 'A' | 'B', stat: keyof TeamCompetitionStats, value: string) => {
  ...
  const handleSelectMatch = (selectedMatchDetails: Record<string, unknown>) => {
    setMatchHeader(selectedMatchDetails.matchHeader as string);
    setStadium(selectedMatchDetails.stadium as string);
    setExtendedInfo(selectedMatchDetails.extendedInfo as string);
    setCompetitionLogo(selectedMatchDetails.competitionLogo as string);
    setTeamA(selectedMatchDetails.teamA as string);
    setTeamB(selectedMatchDetails.teamB as string);
    setTeamALogo(selectedMatchDetails.teamALogo as string);
    setTeamBLogo(selectedMatchDetails.teamBLogo as string);
    setMaxSets(selectedMatchDetails.maxSets as number);
  ...
  const renderStatInputs = (statsA: TeamCompetitionStats, statsB: TeamCompetitionStats) => (
