...
export const PRE_MATCH_SEQUENCE = {
    id: 'PRE_MATCH',
...
export const MATCH_START_SEQUENCE = {
    id: 'MATCH_START',
    ...
    trigger: {
        ...
        condition: (data, state) => {
            const shouldTrigger = data.matchStarted && !state.prevMatchStarted;
            state.prevMatchStarted = data.matchStarted;
...
export const TIMEOUT_SEQUENCE = {
    ...
    trigger: {
        type: 'socketEvent',
        event: 'matchData',
        condition: (data) => data.matchEvent?.type === 'timeout',
    },
    defaultEnabled: true,
...
export const SET_END_SEQUENCE = {
    ...
    trigger: {
        ...
        initialState: { prevMatchStarted: false },
        condition: (data, state) => {
            const isFallingEdge = state.prevMatchStarted && !data.matchStarted;
            state.prevMatchStarted = data.matchStarted;
            return isFallingEdge && !data.winner;
        },
    },
    defaultEnabled: true,
...
export const MATCH_END_SEQUENCE = {
    id: 'MATCH_END',
